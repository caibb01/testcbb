...
#
#     def test01_insert_main_page_popup(self):
#         """
#         新增弹窗用例----首页
#         """
#         params = {
#             "popup_name": "UI自动化弹窗首页",
...
#
#     def test02_insert_area_popup(self):
#         """
#         新增弹窗用例----区域
#         """
#         params = {
#             "popup_name": "UI自动化弹窗区域",
#             "project_relation_name": "全局",
#             "control_page": ["区域", "百色"],
#             "jump_page": ["按类型", "项目楼盘", "全部"],
#             "condition": "每次进入",
...
#         self._need_delete.append(params)
#
#     def test03_insert_project_popup(self):
#         """
#         新增弹窗用例----项目
#         """
#         params = {
#             "popup_name": "UI自动化弹窗项目",
#             "project_relation_name": "全局",
#             "control_page": ["项目", "营销自动化测试"],
#             "jump_page": ["按类型", "项目楼盘", "全部"],
#             "condition": "每次进入",
#             "start_and_end_time": self._get_start_time_and_end_time(start_time=1, end_time=2),
...
#         self.popupManagementLogic.insert_popup(params=params)
#
#     def test04_editor_project_popup(self):
#         """
#         编辑弹窗用例----项目
#         """
#         params = {
#             "popup_name_old": "UI自动化弹窗项目",
#             "popup_name": "编辑UI自动化弹窗",
#             "project_relation_name": "全局",
#             "control_page": ["区域", "百色"],
#             "jump_page": ["按类型", "项目楼盘", "全部"],
#             "condition": "首次进入",
...
#             "image_path": os.path.join(self.__image_path, 'penguin01.jpg'),
#         }
#         self.popupManagementLogic.editor_popup(params=params)
#
