...
class ManageRoleCase(My4wTestCase):
    __author__ = "chenyz01"
    # 当前模块名
    ...
    @classmethod
    def setUpClass(cls):
        super(ManageRoleCase, cls).setUpClass()
    ...
    def setUp(self):
        super(ManageRoleCase, self).setUp()
        # 初始化置业顾问页面-关闭保护期开关
...
if __name__ == '__main__':
    ...
    # unittest.main()
    # os.path.join(os.path.abspath(os.path.join(os.getcwd(), "../..")), 'data', 'image')
    import os
