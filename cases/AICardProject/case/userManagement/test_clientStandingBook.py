...
class test_clientStandingBook(TestCase):
    ...
    # # @data(*excel_click_next_page.next())
    # # def test_08_click_next_page(self,data):
    # #     '''点击下一页直到查找的电话号码'''
    # #     params = {
    # #         'modelName' : data['model'],
    # #         'standardPhone' : data['standardPhone'],
    # #         'flag': data['flag'],
    # #         'msg': data['msg'],
    # #         'checkData': {
    # #             'standardData': data['standardPhone'],
    ...
    # #         }
    # #     }
    # #     self.clientStandingBookLg.click_next_page_lg(params)
    #
    # # @data(*excel_click_previous_page.next())
    # # def test_09_group_cusromer_click_previous_page(self,data):
    # #     '''点击上一页直到第一页'''
    # #     params = {
    # #         'modelName': data['model']
    # #     }
    # #     self.clientStandingBookLg.group_cusromer_click_previous_page_lg(params)
    #
    #
