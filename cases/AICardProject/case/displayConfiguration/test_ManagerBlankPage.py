...
class test_managerBlankPageCase(TestCase):
    __author__ = "chenyz01"
    # 当前模块名
    ...
    @classmethod
    def setUpClass(cls):
        super(test_managerBlankPageCase, cls).setUpClass()
    ...
    def setUp(self):
        super(test_managerBlankPageCase, self).setUp()

    # def tearDown(self):
    #     super(test_managerBlankPageCase, self).tearDown()
    ...
    def tearDownClass(cls):
        super(test_managerBlankPageCase, cls).tearDownClass()
